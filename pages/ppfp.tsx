...
import PPFPTable from '@components/common/PPFPTable'
...
export async function getServerSideProps ({
  ...
  const pageItem = pages.find((p) =>
    p.url ? getSlug(p.url) === 'en-US/paper-poly-foil-poly' : false
  )
  const d =
    pageItem &&
    ...
    <Container>
      ...
      <div className="grid grid-cols-12 gap-4 mt-3 mb-20">
        ...
        <div className="col-span-10">
          ...
          {data
            ? (
            <PPFPTable data={p} categories={categories} />
              )
            : (
