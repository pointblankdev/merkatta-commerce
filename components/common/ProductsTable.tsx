        ...
        <thead className="justify-start text-center">
          <tr className="bg-secondary">
            ...
            <th className="px-4 py-2">
              <span className="text-gray-300">Max cut width</span>
            </th>
            <th className="px-2 py-2">
              <span className="text-gray-300">Ships within 24 hours</span>
            </th>
            <th className="px-2 py-2">
              <span className="text-gray-300">Trial rolls offered</span>
            </th>
            <th className="px-2 py-2">
          ...
          {data.map((node) => (
            ...
            >
              <td className="px-16 py-2 flex flex-row items-center overflow-hidden select-none pointer-events-none">
                ...
                />
                <div className="text-3xl -ml-14 font-thin">PPFP</div>
              </td>
