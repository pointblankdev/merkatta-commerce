          ...
          <div className="pt-12 sm:pt-16 lg:pt-20">
            ...
            <div className="mt-6 text-gray-500 space-y-6">
              <p className="text-lg">
                ...
                erat arcu morbi. Cursus faucibus nunc nisl netus morbi vel porttitor vitae
              ...
              <p className="text-base leading-7">
                ...
                ut volutpat donec laoreet quam urna. Sollicitudin tristique eros erat odio
                sed vitae, consequat turpis elementum. Lorem nibh vel, eget pretium arcu
